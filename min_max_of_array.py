...
If N is odd, set m (min) and M (max) as the first element in the array. That's 0 comparison.
...
Time: O(N), Space: O(1)
https://youtu.be/XJytDszgN14?t=3827
'''
